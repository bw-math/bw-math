...
We will use **Python** in class to quickly generate :ref:`_graphical_representations_of_data` and perform statistical analysis. The pages below should serve as a reference.
