...
1. Download the *csv* dataset in the :ref:`project_three_dataset` section and place it in the ``Linux Files`` folder on your folder system where you save your ``.py`` scripts.
...
.. note::
	...
	Read the :ref:`project_three_datasets` section carefully. You will need to clean the data before you are able to construct the histograms properly.
